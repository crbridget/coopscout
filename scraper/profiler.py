...
A profiler class that demonstrates use of decorates, static variables, and
...
IT'S ALL ABOUT "EFFICIENCY" (AN IMPORTANT SOFTWARE GOAL)!!!!
...
def profile(f):
    """ Convinience function to make decorater tags impler
